...
namespace WebApp.SamplePages
{
    public partial class JobApplication : System.Web.UI.Page
    {
        ...
        {
            //we will assume all data is valid
            ...
            //one can step through the collection line by line using the foreach loop
            ...
            gvCollection.Add(new GridViewCollection(fullname, email, phone, fullorparttime, jobs));
